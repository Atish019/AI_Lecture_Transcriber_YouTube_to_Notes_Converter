...
def generate_notes(transcript_text, subject):
    if subject == "Physics":
        ...
        prompt = """
            ...
            - Applications of Generative AI in fields like:
                - Image generation
                - Text generation (Chatbots, summarization)
                - Audio/music synthesis
                - Drug discovery, gaming, education, etc.
            - Ethical concerns and challenges such as:
                - Deepfakes
                - AI bias
                - Copyright issues
            - Latest trends and tools in the GenAI ecosystem (e.g., OpenAI, Gemini, HuggingFace, etc.)

            Use clear examples, analogies, or diagrams wherever helpful.
            Maintain an academic yet easy-to-understand tone.

            Please provide the YouTube video transcript, and I'll generate the comprehensive Generative AI notes accordingly.
        """
...
def main():
    ...
    subject = st.selectbox("Select Subject:", ["Physics", "Generative AI", "Mathematics", "Data Science and Statistics"])
